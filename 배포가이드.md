...
### 반드시 해야 할 것 🚨
1. **MQTT broker IP 설정** - 로봇 PC IP 확인 후 config.json 수정
2. **PyTorch CUDA 설치** - GPU 가속 필수
3. **자동 로드/실행 설정** - 재부팅 시 자동 동작
